document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (event) {
    ...
    const rendaPerCapita = document.querySelector(
      'input[name="renda_per_capita"]:checked'
    );
    const tempoInteresse = document.querySelector(
      'input[name="tempo_interesse"]:checked'
    );
    ...
    if (!tempoInteresse) {
      ...
      if (tempoInteresse.value == "Não me interesso") {
        ...
        form.setAttribute("action", "/interesse_em_arte");
      }
    }
